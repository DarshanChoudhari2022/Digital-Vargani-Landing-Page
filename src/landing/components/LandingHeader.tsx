...
const navItems = {
  en: [['#about', 'What is Samavet'], ['#organizations', 'For organizations'], ['#epawati', 'ePawati'], ['#features', 'Features'], ['#how-it-works', 'How it works']],
  mr: [['#about', 'समवेत म्हणजे काय?'], ['#organizations', 'संस्थांसाठी'], ['#epawati', 'ई-पावती'], ['#features', 'वैशिष्ट्ये'], ['#how-it-works', 'कसे काम करते']],
} as const;
  ...
  return (
    <header className="landing-header">
      <a className="landing-wordmark" href="#top" aria-label="Samavet home">
        {language === 'mr' ? <span lang="mr">समवेत</span> : <strong>SAMAVET</strong>}
      </a>
      <nav className={menuOpen ? 'landing-nav is-open' : 'landing-nav'} aria-label="Primary navigation">
        ...
        <div className="mobile-language-switch" aria-label="Language selection">
          ...
          <span>/</span>
          <button aria-label="मराठी" className={language === 'mr' ? 'active' : ''} onClick={() => onLanguageChange('mr')} type="button" lang="mr">मर</button>
        </div>
      </nav>
